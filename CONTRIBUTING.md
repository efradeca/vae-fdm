...
- **Not break existing tests** (all 105 tests must pass)
...
python benchmarks/verify_all.py                         # 17 verification checks
...
python benchmarks/benchmark_neural_vs_classical.py      # Neural vs classical (paired bootstrap CI)
...
python benchmarks/benchmark_vae_diversity.py            # VAE diversity quantification (CSV export)
```
