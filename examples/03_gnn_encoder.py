"""Example 03: Use a GNN encoder for mesh-based form-finding.

This example demonstrates training with a Graph Neural Network encoder.
The same GNN architecture works on different mesh sizes, though each
model instance is built for a specific topology (edge_index fixed at
construction).
