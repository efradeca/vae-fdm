...
from optimize import calculate_params_bounds, calculate_params_init
...
def predict_optimize_batch(
    ...
    for i, xyz in enumerate(xyz_slice):
        ...
        # predict with pretrained model -- pass structure so GNN encoders work
        q0 = model.encode(xyz.ravel(), structure=structure)
